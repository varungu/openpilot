...
_FACE_THRESHOLD = 0.5
_PARTIAL_FACE_THRESHOLD = 0.75
_EYE_THRESHOLD = 0.5
_SG_THRESHOLD = 0.5
_BLINK_THRESHOLD = 0.88
_BLINK_THRESHOLD_SLACK = 0.98
_BLINK_THRESHOLD_STRICT = 0.88
_PITCH_WEIGHT = 1.175  # pitch matters a lot more
_POSESTD_THRESHOLD = 0.14
_E2E_POSE_THRESHOLD = 0.9
_E2E_EYES_THRESHOLD = 0.75
_METRIC_THRESHOLD = 0.5
_METRIC_THRESHOLD_SLACK = 0.675
_METRIC_THRESHOLD_STRICT = 0.5
